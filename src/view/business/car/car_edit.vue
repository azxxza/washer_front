<template>
  <Drawer title="设备管理-修改" v-model="isShow" width="420" :styles="styles" @on-close="handleClose">
...
import { update } from "@/api/business/car";
  ...
  watch: {
    drawerEdit(value) {
      ...
      if (value) {
        ...
        this.$refs.baseForm.form.termtype = this.$refs.baseForm.form.termtype.toUpperCase();
      }
    },
  },
  mounted() {
