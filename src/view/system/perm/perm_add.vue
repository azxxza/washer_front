          ...
          <Row :gutter="32">
            <Col span="24">
                  <FormItem label="上级菜单" prop="parent">
                      <Cascader :data="data" v-model="form.parent" placeholder="请选择上级菜单" :change-on-select="true"></Cascader>
                  </FormItem>
              </Col>
          </Row>
          <Row :gutter="32">
...
import { savePerm,getPermCascader } from '@/api/system/perm_data'
export default {
  name: 'form_page',
  components: {
    ...
    handleSave () {
      ...
      this.$refs['form'].validate((valid) => {
        if (valid) {
          ...
          savePerm(this.form).then(function (data) {
